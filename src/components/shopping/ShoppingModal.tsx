...
export default function ShoppingModal({ pickup, onSave, onDelete, onClose }: ShoppingModalProps) {
    ...
    >
      ...
      <div className="fg row2">
        ...
        <div><label>カテゴリ</label>
          <input value={category} onChange={e => setCategory(e.target.value)} placeholder="食品" onFocus={scrollToInput} />
        </div>
      </div>
      <div className="fg">
